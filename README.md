...
「画面設計」「ユーザー認証」「データ管理」の基礎を体系的に作成して、「Webブラウザ上でWindowsのような操作感を再現する」ことを目標に
楽しく操作できる仮想デスクトップ環境を目指して開発しました。
...
<img width="706" height="301" alt="image" src="https://github.com/user-attachments/assets/1aadd11c-6e56-4d79-b477-9987ab953702" />
...
（キ）.ブラウザからアクセス
 ...
 　　 googleやEgagの、URL欄に下記アドレスを入力して、Enterキーを押す。
